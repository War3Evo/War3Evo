...
// Chance/Data Arrays
new Float:SuicideBomberRadius[5]={0.0,500.0,580.0,620.0,666.0};

//new Float:SuicideBomberDamage[5]={0.0,25.0,50.0,75.0,100.0};
new Float:SuicideBomberDamageTF[5]={0.0,25.0,50.0,75.0,100.0};
